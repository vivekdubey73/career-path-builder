...
INSERT INTO public.mentors (name, initials, role, title, company, bio, full_bio, skills, match_score, category, available, availability_status, avatar_color, photo_url, is_featured) VALUES
  ('Sarah Chen', 'SC', 'Senior Staff Engineer', 'Senior Staff Engineer', 'Google',
   'ML systems & search infra at Google.',
   'Sarah leads ranking infrastructure at Google Search and previously built recommendation systems at YouTube. Stanford CS, 12+ years scaling ML platforms.',
   ARRAY['Machine Learning','Distributed Systems','Python','Go'], 96, 'Technical', true, 'available_now', 'bg-teal-500',
   'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=400&fit=crop', true),
  ('Michael Rodriguez', 'MR', 'Engagement Manager', 'Engagement Manager', 'McKinsey & Company',
   'Strategy consulting for Fortune 500.',
